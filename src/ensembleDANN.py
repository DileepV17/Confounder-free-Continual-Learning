...
def train_and_benchmark():
    ...
    epochs = 30 # before was 30, 100 did not work well with ACCd
    ...
    print(f"ACCd: {ACCd:.4f} (closer to 0 is better)")
    print(f"BWTd: {BWTd:.4f} (closer to 0 is better)")
    print(f"FWTd: {FWTd:.4f} (closer to 0 is better)")
